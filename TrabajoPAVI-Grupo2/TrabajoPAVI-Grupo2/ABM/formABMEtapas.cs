    ...
    public partial class formABMEtapa : Form
    {
        ...
        private void CargarGrilla()
        {
            ...
            try
            {
                ...
                string consulta = "SELECT * FROM [BD3K3G02_2022].[dbo].[Etapas] ORDER BY id_etapa";
        ...
        private bool AgregarEtapaABD(Etapa etapa)
        {
            ...
            // MOdificadoooooooooooooooooooooooooooooooooooooooooooooo
            try
            {
                ...
                {
                    SqlCommand cmd = new SqlCommand();
                    string consulta = "INSERT INTO [BD3K3G02_2022].[dbo].[ETAPAS] (id_etapa, descripcion) VALUES (@idEtapa, @Descripcion)";
                    cmd.Parameters.Clear();
        ...
        private static bool Existe(string id)
        {
            ...
            {
                string query = "SELECT COUNT(*) FROM [BD3K3G02_2022].[dbo].[ETAPAS] WHERE id_etapa=@Id";
        ...
        private Etapa ObtenerEtapa(string id)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand();
                string consulta = "SELECT * FROM [BD3K3G02_2022].[dbo].[Etapas] where id_etapa like @id";
                cmd.Parameters.AddWithValue("@id", id);
        ...
        private bool ActualizarEtapaABD(Etapa etapa)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand();
                string consulta = "UPDATE [BD3K3G02_2022].[dbo].[Etapas] SET id_etapa = @idEtapa, descripcion = @Descripcion WHERE id_etapa like @idEtapa";
                cmd.Parameters.Clear();
                cmd.Parameters.AddWithValue("@idEtapa", etapa.IdEtapa);
                cmd.Parameters.AddWithValue("@Descripcion", etapa.DescripcionEtapa);
        ...
        private bool Eliminar(Etapa etapa)
        {
            ...
            try
            {
                ...
                string consulta = "DELETE FROM [BD3K3G02_2022].[dbo].[Etapas] WHERE  id_etapa = @id_etapa ";
                cmd.Parameters.Clear();
