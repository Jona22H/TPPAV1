    ...
    public partial class FrmABMEtapasXProyecto : Form
    {
        ...
        private void CargarGrilla()
        {
            ...
            try
            {
                ...
                string consulta = "SELECT cod_proyecto, id_etapa, fecha_inicio, fecha_fin FROM [BD3K3G02_2022].[dbo].[ETAPASxPROYECTO] ORDER BY cod_proyecto ASC, id_etapa";
        ...
        private void CargarComboCodProyecto()
        {
            ...
            try
            {
                ...
                string consulta = "SELECT codigo FROM [BD3K3G02_2022].[dbo].[PROYECTOS]";
                cmd.Parameters.Clear();
        ...
        private void CargarComboEtapa()
        {
            ...
            try
            {
                ...
                string consulta = "SELECT id_etapa FROM [BD3K3G02_2022].[dbo].[ETAPAS]";
                cmd.Parameters.Clear();
        ...
        private bool AgregarEtapaXProyectoABD(EtapaXProyecto etapaXProyecto)
        {
            ...
            try
            {
                ...
                {
                    SqlCommand cmd = new SqlCommand();
                    string consulta = "INSERT INTO [BD3K3G02_2022].[dbo].[ETAPASxProyecto] (cod_proyecto, id_etapa, fecha_inicio, fecha_fin) VALUES (@cod_proyecto, @idEtapa, @fecha_inicio, @fecha_fin)";
                    cmd.Parameters.Clear();
        ...
        private static bool Existe(int cod_proyecto, string id_etapa)
        {
            ...
            {
                string query = "SELECT COUNT(*) FROM [BD3K3G02_2022].[dbo].[ETAPASxPROYECTO] WHERE cod_proyecto = @cod_proyecto  AND id_etapa = @id_etapa";
        ...
        private EtapaXProyecto ObtenerEtapaXProyecto(int cod_proyecto, string id_etapa)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand();
                string consulta = "SELECT * FROM [BD3K3G02_2022].[dbo].[ETAPASxProyecto] WHERE cod_proyecto like @cod_proyecto AND id_etapa like @id_etapa";
        ...
        private bool ActualizarEtapaXProyectoABD(EtapaXProyecto etapaXProyecto)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand();
                string consulta = "UPDATE [BD3K3G02_2022].[dbo].[ETAPASxProyecto] SET cod_proyecto = @cod_proyecto, id_etapa = @idEtapa, fecha_inicio = @fecha_inicio, fecha_fin = @fecha_fin WHERE cod_proyecto like @cod_proyecto AND id_etapa like @idEtapa";
                cmd.Parameters.Clear();
                cmd.Parameters.AddWithValue("@cod_proyecto", etapaXProyecto.CodProductoEtapaXProyecto);
                cmd.Parameters.AddWithValue("@idEtapa", etapaXProyecto.IdEtapaXProyecto);
                cmd.Parameters.AddWithValue("@fecha_inicio", etapaXProyecto.FechaInicioEtapaXProyecto);
        ...
        private bool Eliminar(EtapaXProyecto etapaXProyecto)
        {
            ...
            try
            {
                ...
                string consulta = "DELETE FROM [BD3K3G02_2022].[dbo].[ETAPASxProyecto] WHERE cod_proyecto = @cod_proyecto AND  id_etapa = @id_etapa ";
                cmd.Parameters.Clear();
                cmd.Parameters.AddWithValue("@cod_proyecto", etapaXProyecto.CodProductoEtapaXProyecto);
